...
(1, 1, 1, 10, 1), (2, 1, 2, 15, 1), (3, 2, 1, 10, 1), (4, 2, 2, 15, 1), (5, 2, 3, 10, 1), (6, 1, 3, 6, 1), (7, 15, 3, 10, 1), (8, 15, 1, 15, 1), (9, 15, 2, 20, 1), (10, 10, 3, 7, 1), (11, 10, 1, 10, 1), (12, 10, 2, 15, 1), (13, 11, 3, 8, 1), (14, 11, 1, 10, 1), (15, 11, 2, 14, 1), (16, 12, 3, 10, 1), (17, 12, 1, 12, 1), (18, 12, 2, 14, 1), (19, 16, 3, 9, 1), (20, 16, 1, 11, 1), (21, 16, 2, 13, 1), (22, 19, 3, 8, 1), (23, 19, 1, 10, 1), (24, 19, 2, 12, 1), (25, 26, 10, 7, 1), (26, 25, 10, 8, 1), (27, 24, 10, 7, 1), (28, 23, 11, 6, 1), (29, 22, 8, 5, 1), (30, 21, 9, 3, 1), (31, 20, 8, 3.5, 1), (32, 13, 3, 8, 1), (33, 13, 1, 10, 1), (34, 13, 2, 12, 1), (35, 14, 3, 9, 1), (36, 14, 1, 11, 1), (37, 14, 2, 13, 1), (38, 17, 3, 8, 1), (39, 17, 1, 10, 1), (40, 17, 2, 13, 1), (41, 18, 3, 8, 1), (42, 18, 1, 10, 1), (43, 18, 2, 12, 1);
...
(1, 'info@shishov.dev', '$2a$10$nS7m1Lp9y1M9j9.zG9qOYeQf5M8y3Gz/p6.U2qA8gLh7iR9v1lG2y', 'Mikhail', 'Shishov', '+421952031817', 'USER', NULL, '2025-12-27 09:13:35', b'1', NULL, NULL, NULL),
(3, 'shishovmike96@gmail.com', '$2a$10$eKa3iFYGouHsAKOMLOT9VOY0YsMe1Z8mVi96KuE8pLzTxqfbIyV8.', 'Admin', 'User', '+421952031817', 'ADMIN', '/uploads/avatars/user_3_5.jpg', '2025-12-27 19:45:33', b'1', NULL, NULL, NULL),
(4, 'cook@opizza.sk', '$2a$10$EQ0FHJQEZPkddczhJHjYgOPo7PckNou/BORyZOXhI/fEpIufWy.2i', 'James', 'Cook', '+421901234567', 'COOK', NULL, '2026-01-07 20:27:01', b'1', NULL, NULL, NULL),
...
(7, 'test.user@opizza.sk', '$2a$10$bPyiu8tjZs.fnwYH1hwMQenErTmn2R47/jobQ0Rri93gh.biFoFby', 'Test', 'User', '+421900123456', 'USER', '/uploads/avatars/user_7_fresh.png', '2026-01-09 11:47:00', b'1', NULL, NULL, NULL);
...
-- Update Default Addresses in Users
UPDATE `users` SET `default_address_id` = 4 WHERE `user_id` = 1;
UPDATE `users` SET `default_address_id` = 1 WHERE `user_id` = 3;
UPDATE `users` SET `default_address_id` = 6 WHERE `user_id` = 4;
UPDATE `users` SET `default_address_id` = 8 WHERE `user_id` = 7;
...
(1, '/uploads/products/1767906492285_04.jpg', 1, 2), (2, '/uploads/products/1767906529135_au.webp', 0, 2), (3, '/uploads/products/capricciosa.webp', 1, 1), (5, '/uploads/products/carbonara-pizza.webp', 1, 10), (6, '/uploads/products/delicatezza-rustica.webp', 1, 11), (7, '/uploads/products/diavola-piccante.webp', 1, 12), (8, '/uploads/products/funghi-al-panna.webp', 1, 13), (9, '/uploads/products/funghi.webp', 1, 14), (10, '/uploads/products/gluten-free-primavera.webp', 1, 15), (11, '/uploads/products/hawaii-classic.webp', 1, 16), (12, '/uploads/products/la-crema-bianca.webp', 1, 17), (13, '/uploads/products/margherita-classica.webp', 1, 18), (14, '/uploads/products/capricciosa.webp', 1, 19), (15, '/uploads/products/duff.webp', 1, 20), (16, '/uploads/products/nuka-cola.webp', 1, 21), (17, '/uploads/products/schraderbrau.jpg', 1, 22), (18, '/uploads/products/vodka-martini.jpg', 1, 23), (19, '/uploads/products/cherry-pie.webp', 1, 24), (20, '/uploads/products/courtesan-au-chocolat.jpg', 1, 25), (21, '/uploads/products/strudel.jpg', 1, 26), (22, '/uploads/products/1767950821494_pizza-capricciosa_1200x800.jpg', 0, 1);

--
-- Dumping data for table `product_ingredients`
--
INSERT INTO `product_ingredients` (`product_id`, `ingredient_id`) VALUES
(1, 2), (1, 8), (10, 2), (10, 9), (10, 13), (11, 2), (11, 5), (11, 15), (12, 1), (12, 2), (12, 5), (12, 11), (16, 3), (16, 7), (17, 10), (17, 13), (17, 15), (19, 1), (19, 2), (19, 3), (19, 4), (19, 8);

--
-- Dumping data for table `product_tags`
--
INSERT INTO `product_tags` (`product_id`, `tag_id`) VALUES
(2, 2), (10, 1), (10, 5), (11, 1), (11, 3), (12, 4), (15, 2), (16, 5), (18, 3), (19, 1), (24, 5), (26, 2);
